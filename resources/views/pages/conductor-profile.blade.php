        ...
        <form role="form" method="POST" action={{ route('conductor.update') }} enctype="multipart/form-data">
            ...
            <div class="card-header pb-0">
                <div class="d-flex align-items-center">
                    <p class="mb-0">Editar Perfil Conductor</p>
                    <button type="submit" class="btn btn-primary btn-sm ms-auto">Guardar</button>
                </div>
            </div>
            <div class="card-body">
                <p class="text-uppercase text-sm">Informacion Conductor</p>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Licencia</label>
                            <input class="form-control" type="text" name="codigo_lic">
                        </div>
                    </div>
