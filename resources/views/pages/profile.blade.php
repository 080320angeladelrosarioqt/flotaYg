            ...
            <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                <div class="nav-wrapper position-relative end-0">
                    <ul class="nav nav-pills nav-fill p-1" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{  str_contains(request()->url(), 'conductor') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'dashboard']) }} "
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-profile">
                    <img src="./img/flotayungueña/bl4.jpg" alt="Image placeholder" class="card-img-top">
