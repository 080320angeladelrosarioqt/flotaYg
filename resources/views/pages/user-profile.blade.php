                        ...
                        <ul class="nav nav-pills nav-fill p-1" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center justify-content-center "
                                    ...
                                    <span class="ms-2">Herraminetas</span>
                                </a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="row">
                    ...
                    <form role="form" method="POST" action={{ route('profile.update') }} enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Email correo</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" name="fecha_nac"
                                            value="{{ old('fecha_nac', auth()->user()->fecha_nac) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Cedula de Identidad</label>
                                        <input class="form-control" type="text" name="ci"
                                            value="{{ old('ci', auth()->user()->ci) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
            ...
            <div class="col-md-4">
                <div class="card card-profile">
                    <img src="./img/flotayungueña/bl3.jpg" alt="Image placeholder" class="card-img-top">
                    ...
                    <div class="card-header text-center border-0 pt-0 pt-lg-2 pb-4 pb-lg-3">
                        <div class="d-flex justify-content-between">
                            <a href="javascript:;" class="btn btn-sm btn-info mb-0 d-none d-lg-block">Celular</a>
                    ...
                    <div class="card-body pt-0">
                            ...
                            <div class="col">
                                <div class="d-flex justify-content-center">
                                    <div class="d-grid text-center">
                                        ...
                                        <span class="text-sm opacity-8">Trabajo</span>
                                    </div>
                        ...
                        <div class="text-center mt-4">
                            <h5>
                                {{ old('firstname', auth()->user()->firstname) }}<span class="font-weight-light">, 35</span>
                            </h5>
                            <div class="h6 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ old('city', auth()->user()->city) }}, {{ old('country', auth()->user()->country) }}
                            </div>
                            <div class="h6 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>Cargo
                            </div>
                            <div>
                                <i class="ni education_hat mr-2"></i>Area
                            </div>
                        </div>
                    </div>
                </div>
