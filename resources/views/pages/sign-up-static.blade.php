...
<main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-70 pt-3 pb-11 m-3 border-radius-lg"
        style="background-image: url('./img/flotayungueña/fl3.jpg'); background-position: top;">
        <span class="mask bg-gradient-dark opacity-8"></span>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 text-center mx-auto">
                    <h1 class="text-white mb-4 mt-7">Bienvenido!</h1>
                    <p class="text-lead text-white">Llene el formulario, y sea parte de la familia Flota Yungueña. Pionera en el transporte interdepartamental.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="container mt-3">
        <div class="row mt-lg-n11 mt-md-n8 mt-n10 justify-content-center">
